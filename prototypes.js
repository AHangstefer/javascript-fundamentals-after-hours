...
/* == Step 1: Base Constructor ==
  Create a constructor function named CircleMaker that
   accepts a property for diameter
*/
...
/* == Step 2: area Method ==
  Create a method using CircleMaker's prototype that returns
...
/* == Step 3: Circumference Method ==
  Create another method using CircleMaker's prototype that
  returns the circumference of a given circle. 
...
/* == Step 4: Create a new object that uses CircleMaker ==
  Create a circle object that uses the new keyword to use
   our CircleMaker constructor
  Add a properties and values of diameter: 5 to circle. 
*/

const circle = new CircleMaker(5);

// Test your area and circumference methods by uncommenting
 // the logs below:
// console.log(circle.area()); // 19
// console.log(circle.circumference()); // 15